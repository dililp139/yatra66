...
export default function SihTripPlanner({
  ...
  const allPlannerCities = useMemo(() => {
    const defaultList = [
      ...
      // Offbeat Gems
      { id: 25, name: 'Bundi', state: 'Rajasthan', region: 'North India', themes: ['heritage', 'stepwells', 'offbeat'], rating: 4.8, estimatedDailyBudget: 2800, heroImage: 'https://images.unsplash.com/photo-1599602193934-2936d8b8f5e8?w=800', bestSeason: 'Oct to Mar' },
